    ...
    <form class="index">
        ...
        <div class="horas">
            <fieldset>
                ...
                <input type="radio"class="radio-button" id="ninguno" value="0">Ninguno
                <input type="radio"class="radio-button" id="op2" value="50"> 4 horasXsemanaX1mes
                <input type="radio"class="radio-button" id="op3" value="80"> 4 horasXsemanaX2meses
                <input type="radio"class="radio-button" id="op4" value="100"> 8 horasXsemanaX1mes
                <input type="radio"class="radio-button" id="op5" value="150"> 8 horasXsemanaX2meses
            </fieldset>
        </div>
